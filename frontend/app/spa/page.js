    ...
    <main className="min-h-screen bg-white pb-20">
      ...
      <div className="relative h-[60vh] w-full overflow-hidden bg-gray-900">
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center text-center text-white px-5">
            <p className="text-sm font-bold tracking-[4px] uppercase mb-6 animate-fade-in-up">Sanctuary for the Senses</p>
            <h1 className="font-serif text-6xl md:text-8xl mb-6 animate-fade-in-up delay-100">Wellness & Spa</h1>
        </div>
      </div>
        ...
        <div className="max-w-[90%] mx-auto flex flex-col lg:flex-row items-center gap-20">
            ...
            <div className="lg:w-1/2 text-left lg:pl-10">
                ...
                <p className="text-lg text-secondary font-light leading-loose mb-10">
                    Step into a world of tranquility. Our spa philosophy is grounded in the belief that wellness is a journey, not a destination. We combine ancient Asian healing traditions with modern techniques to create a personalized experience for every guest.
                </p>
                <div className="grid grid-cols-2 gap-8 mb-10">
                    <div>
                        <h4 className="font-serif text-2xl mb-2">10+</h4>
                        <p className="text-xs tracking-widest uppercase text-gray-500">Treatment Rooms</p>
                    </div>
                    <div>
                        <h4 className="font-serif text-2xl mb-2">100%</h4>
                        <p className="text-xs tracking-widest uppercase text-gray-500">Natural Ingredients</p>
                    </div>
                </div>
            </div>
        </div>
      ...
      <section className="py-24 bg-gray-50 px-5">
        <div className="max-w-[90%] mx-auto">
            <div className="text-center mb-20">
                <span className="block text-xs font-bold text-gray-500 tracking-[4px] uppercase mb-4">Our Selection</span>
                <h2 className="font-serif text-4xl lg:text-5xl text-primary">Signature Treatments</h2>
            </div>

            <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
                {treatments.map((item) => (
                    <div key={item.id} className="group bg-white p-0 shadow-sm hover:shadow-xl transition-all duration-500">
                        ...
                        <div className="p-8 text-center">
                            <h3 className="font-serif text-2xl text-primary mb-2">{item.name}</h3>
                            <p className="text-xs font-bold text-accent uppercase tracking-widest mb-4">{item.duration}</p>
                            <p className="text-sm text-secondary font-light leading-relaxed mb-6">
                                {item.desc}
                            </p>
                            <Link href="/#booking" className="text-[10px] font-bold uppercase tracking-widest border-b border-primary pb-1 hover:text-accent hover:border-accent transition-colors">
                                Book Now
                            </Link>
                        </div>
                    </div>
        ...
        <div className="max-w-[96%] mx-auto relative lg:h-[600px] flex flex-col lg:block">
           ...
           <div className="relative lg:absolute top-0 lg:top-1/2 right-0 lg:right-[8%] lg:transform lg:-translate-y-1/2 bg-white p-10 lg:p-16 max-w-xl shadow-none lg:shadow-xl mt-[-50px] lg:mt-0 mx-5 lg:mx-0">
              ...
              <p className="text-lg text-secondary font-light leading-loose mb-8">
                Extend your wellness journey with our exclusive range of spa products. From aromatic essential oils to handcrafted ceramics, take a piece of tranquility with you.
              </p>
              <a href="#" className="inline-block border border-primary px-10 py-4 text-sm font-bold tracking-[2px] uppercase hover:bg-primary hover:text-white transition-all">
                View Collection
              </a>
           </div>
        </div>
